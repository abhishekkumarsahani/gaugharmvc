        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PregnancyDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Cows_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalAmount = table.Column<decimal>(type: "decimal(10,2)", nullable: false, computedColumnSql: "[Quantity] * [RatePerLiter]"),
                    Remarks = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MilkSales_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MorningQuantity = table.Column<decimal>(type: "decimal(5,2)", nullable: false),
                    EveningQuantity = table.Column<decimal>(type: "decimal(5,2)", nullable: false),
                    TotalQuantity = table.Column<decimal>(type: "decimal(5,2)", nullable: false, computedColumnSql: "[MorningQuantity] + [EveningQuantity]"),
                    Remarks = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MilkRecords_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Animal feed and grass", "Fodder" },
                    { 2, "Veterinary medicines", "Medicine" },
                    { 3, "Employee wages", "Staff Salary" },
                    { 4, "Electricity bills", "Electricity" },
                    { 5, "Water bills", "Water" },
                    { 6, "Repairs and maintenance", "Maintenance" },
                    { 7, "Transportation costs", "Transport" },
                    { 8, "Miscellaneous expenses", "Others" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Cows_TagNumber_UserId",
                table: "Cows",
                columns: new[] { "TagNumber", "UserId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MilkRecords_CowId_Date",
                table: "MilkRecords",
                columns: new[] { "CowId", "Date" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_MilkRecords_UserId",
                table: "MilkRecords",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_MilkSales_UserId",
                table: "MilkSales",
                column: "UserId");
